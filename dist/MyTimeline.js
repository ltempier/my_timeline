...
var MyTimeline = function () {
    ...
    _createClass(MyTimeline, [{
        ...
        key: '_refreshDots',
        value: function _refreshDots(force) {
            var _this = this;
            ...
            dots.forEach(function (dot) {
                ...
                $td.html(dot.text);
                $td.width(dot.width);
                _this.$dots.append($td);
            });
        }
    }, {
        key: '_refreshSlider',
        value: function _refreshSlider() {
        ...
        key: '_onSliderChange',
        value: function _onSliderChange(sliderValue) {
            var minDelta, buffer;
            this.slider.values.some(function (value) {
                ...
                if (minDelta == null || delta < minDelta) {
                    minDelta = delta;
                    buffer = value;
                } else if (delta > minDelta) return true;
                return false;
            });

            if (this._oldSliderValue && this._oldSliderValue == buffer) return;
